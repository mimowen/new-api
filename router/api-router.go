...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/model_rank/category/add", controller.AddCategory)
		apiRouter.POST("/model_rank/category/remove", controller.RemoveCategory)
		apiRouter.POST("/model_rank/model/add", controller.AddModelToConfig)
		apiRouter.POST("/model_rank/model/remove", controller.RemoveModelFromConfig)
		apiRouter.POST("/model_rank/config/save", controller.SaveConfig)
		apiRouter.POST("/model_rank/config/reload", controller.ReloadConfig)
		apiRouter.GET("/model_rank/mode", controller.GetInterceptorMode)
		apiRouter.POST("/model_rank/mode", controller.SetInterceptorMode)
		apiRouter.GET("/model_rank/capture", controller.GetCapturePage)
		apiRouter.GET("/model_rank/capture/records", controller.GetCaptureRecords)
		apiRouter.POST("/model_rank/capture/delete", controller.DeleteCaptureRecords)
		apiRouter.POST("/model_rank/capture/delete_all", controller.DeleteAllCaptureRecords)
